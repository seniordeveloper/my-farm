...
namespace MyFarm.Log
{
    ...
    public class AppLogger : ILogger
    {
        ...
        public void Info(string message, [CallerFilePath] string filePath = "", [CallerMemberName] string methodName = "")
        {
            _logger.Information($"{message}|{GetCallerPath(filePath, methodName)}");
        }

        public void Warn(string message, [CallerFilePath] string filePath = "", [CallerMemberName] string methodName = "")
        {
            _logger.Warning($"{message}|{GetCallerPath(filePath, methodName)}");
        }

        public void Error(Exception exception, [CallerFilePath] string filePath = "", [CallerMemberName] string methodName = "")
        {
